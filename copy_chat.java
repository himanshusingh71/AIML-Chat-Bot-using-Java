 ...
 class ChatBot extends JFrame implements ActionListener
{
	 ...
	 ChatBot(String title)
	{
		...
		// BUTTON
		send = new JButton("...");
		send.setFont(new Font("Quicksand",Font.BOLD,10));
		...
		add(area);
		area.setFont(new Font("Quicksand",Font.PLAIN,20));
		...
		field.setFont(new Font("Quicksand",Font.BOLD,25));
		add(field);
	...
	public static void main(String[] args) 
	{
		...
		ChatBot cb=new ChatBot("tHe bOt");
		cb.setSize(800,605);
